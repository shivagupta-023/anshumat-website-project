...
const Hero = () => {
  return (
    <div className="bg-gradient-to-br from-blue-100 via-slate-50 to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 text-center py-20 lg:py-32 px-6 border-b border-slate-200/50 dark:border-gray-800">
      <motion.h1 
